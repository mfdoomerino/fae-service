defmodule FaeService.DirectoryTest do
  use FaeService.DataCase

  alias FaeService.Directory

  describe "businesses" do
    alias FaeService.Directory.Business
    ...
    test "list_businesses/0 returns all businesses" do
      assert business_fixture() in Directory.list_businesses()
    end
